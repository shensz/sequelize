  ...
  */
    ...
    if (options.include) {
      var generateJoinQueries = function(include, parentTable) {
        ...
        if (tableName !== parentTable && mainTableAs !== parentTable) {
          as = parentTable + QueryCons.TABLE_SEPARATOR + include.as;
        }
  ...
  joinIncludeQuery: function(options) {
    ...
    while (($parent = ($parent && $parent.parent || include.parent)) && $parent.association) {
      if (asLeft) {
        asLeft = [$parent.as, asLeft].join(QueryCons.TABLE_SEPARATOR);
      } else {
        asLeft = $parent.as;
      }
    }
    ...
    else asRight = [asLeft, asRight].join(QueryCons.TABLE_SEPARATOR);
